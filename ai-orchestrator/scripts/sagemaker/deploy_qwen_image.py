#!/usr/bin/env python3
"""Deploy Qwen-Image model to AWS SageMaker.

This script creates a SageMaker endpoint for the Qwen-Image model.
"""
...
def wait_for_endpoint(sagemaker_client, endpoint_name: str, timeout: int = 600):
...
def main():
    parser = argparse.ArgumentParser(description="Deploy Qwen-Image model to SageMaker")
    parser.add_argument("--region", default="us-west-2", help="AWS region")
    parser.add_argument("--model-name", default="qwen-image-model", help="Model name")
    parser.add_argument("--endpoint-name", default="qwen-image-endpoint", help="Endpoint name")
    ...
    print("=" * 60)
    print("Deploying Qwen-Image Model to SageMaker")
    print("=" * 60)
    ...
    print(f"SAGEMAKER_QWEN_IMAGE_ENDPOINT={args.endpoint_name}")
